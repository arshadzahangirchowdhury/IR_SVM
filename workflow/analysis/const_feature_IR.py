...
keep features constant and assess performance at different resolutions.
"""
...
print("Test Accuracy:")
FCA_OVR_Test_Res_0d01_1600_1610, cm_OVR_Test_Res_0d01_1600_1610 = svm_clf_post_processor(pred_y, test_y, s.labels, 
                                         figure_save_file = 'RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/CM_Test_Res_0d01_1600-1610.png')


pred_y = classifier_OVR.predict(train_X)
print("Train Accuracy:")
FCA_OVR_Train_Res_0d01_1600_1610, cm_OVR_Train_Res_0d01_1600_1610= svm_clf_post_processor(pred_y, train_y, s.labels, 
                                         figure_save_file = 'RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/CM_Train_Res_0d01_1600-1610.png')
...
FCA_OVR_Valid_Res_0d01_1600_1610, cm_OVR_Valid_Res_0d01_1600_1610 = svm_clf_post_processor(pred_y, y, s.labels, 
                                         figure_save_file = 'RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/CM_Valid_Res_0d01_1600-1610.png')
...
fig.savefig('RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/PR_Curve_Res_0d01_1600-1610.png', bbox_inches='tight',dpi=300)

RECALL_CASE1=recall['micro']
PRECISION_CASE1=precision['micro']


#1600-1700
s = IR_data(data_start = 1600, data_end = 1700, resolution=0.1, verbosity = False)
s.load_IR_data()
s.make_dataframe(s.spectra)
s.dataset_info()
...
pred_y = classifier_OVR.predict(test_X)
print("Test Accuracy:")
FCA_OVR_Test_Res_0d1_1600_1700, cm_OVR_Test_Res_0d1_1600_1700 = svm_clf_post_processor(pred_y, test_y, s.labels, 
                                         figure_save_file = 'RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/CM_Test_Res_0d1_1600-1700.png')
####
...
print("Train Accuracy:")
FCA_OVR_Train_Res_0d1_1600_1700, cm_OVR_Train_Res_0d1_1600_1700 = svm_clf_post_processor(pred_y, train_y, s.labels, 
                                         figure_save_file = 'RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/CM_Train_Res_0d1_1600-1700.png')
...
FCA_OVR_Valid_Res_0d1_1600_1700, cm_OVR_Valid_Res_0d1_1600_1700 = svm_clf_post_processor(pred_y, y, s.labels, 
                                         figure_save_file = 'RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/CM_Valid_Res_0d1_1600-1700.png')
...
fig.savefig('RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/PR_Curve_0d1_1600-1700.png', bbox_inches='tight',dpi=300)

RECALL_CASE2=recall['micro']
PRECISION_CASE2=precision['micro']
...
FCA_OVR_Test_Res_1_1200_2200, cm_OVR_Test_Res_1_1200_2200 = svm_clf_post_processor(pred_y, test_y, s.labels, 
                                         figure_save_file = 'RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/CM_Test_Res_1_1200-2200.png')
...
print("Train Accuracy:")
FCA_OVR_Train_Res_1_1200_2200, cm_OVR_Train_Res_1_1200_2200 = svm_clf_post_processor(pred_y, train_y, s.labels, 
                                         figure_save_file = 'RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/CM_Train_Res_1_1200-2200.png')
...
FCA_OVR_Valid_Res_1_1200_2200, cm_OVR_Valid_Res_1_1200_2200= svm_clf_post_processor(pred_y, y, s.labels, 
                                         figure_save_file = 'RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/CM_Valid_Res_1_1200-2200.png')
...
fig.savefig('RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/PR_Curve_Res_1_1200-2200.png', bbox_inches='tight',dpi=300)

RECALL_CASE3=recall['micro']
PRECISION_CASE3=precision['micro']


Cases = ['$10^{-2}$', '$10^{-1}$', '$10^0$']

Train = [100*FCA_OVR_Train_Res_0d01_1600_1610,100*FCA_OVR_Train_Res_0d1_1600_1700, 100*FCA_OVR_Train_Res_1_1200_2200]
Test = [100*FCA_OVR_Test_Res_0d01_1600_1610,100*FCA_OVR_Test_Res_0d1_1600_1700, 100*FCA_OVR_Test_Res_1_1200_2200]
Validation = [100*FCA_OVR_Valid_Res_0d01_1600_1610,100*FCA_OVR_Valid_Res_0d1_1600_1700, 100*FCA_OVR_Valid_Res_1_1200_2200]
...
ax.set_xlabel('Resolution ($cm^{-1}$)',fontsize=18, fontweight='bold')
ax.set_title('Accuracy vs no. of features or variable'
    .format(average_precision["micro"]),fontsize=18, fontweight='bold')

ax.set_title('Same nine compounds classified in each group\nNo. of features = $10^3$'
    .format(average_precision["micro"]),fontsize=18, fontweight='bold')
...
fig.savefig('RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/Accuracy_Compared.png', bbox_inches='tight',dpi=300)
...
plt.rc('font', weight='bold')
ax_def.step(RECALL_CASE1, PRECISION_CASE1, where='post', linewidth=1.0,label='1600-1610 $cm^{-1}, f_{res}=0.01 \, cm^{-1}$')
ax_def.step(RECALL_CASE2, PRECISION_CASE2, where='post', linewidth=1.0,label='1600-1700 $cm^{-1}, f_{res}=0.1 \, cm^{-1}$')
ax_def.step(RECALL_CASE3, PRECISION_CASE3, where='post', linewidth=1.0,label='1200-2200 $cm^{-1}, f_{res}=1 \, cm^{-1}$')
...
fig.savefig('RESULTS/Substudy_Figures/Study_Same_Compounds_Diff_Res/PR_Curves_Compared.png', bbox_inches='tight',dpi=300)